...
(function () {
  ...
  const EN = {
    ...
    "Heute": "Today",
    "Gestern": "Yesterday",
    "Song ist nicht mehr in der Bibliothek.": "This song is no longer in the library.",
    "🔀 Ganze Bibliothek mischen": "🔀 Shuffle whole library",
    "Bibliothek ist leer.": "Library is empty.",
    "Stille am Anfang/Ende": "Silence at start/end",
    ...
    "Qualität aufwerten": "Improve quality",
    "Sucht MP3s unter 192 kbps und holt auf Wunsch eine bessere Fassung nach - bevorzugt die reine Audiospur („- Topic“) statt der Videoversion. Ersetzt wird nur, wenn die gefundene Fassung wirklich höher aufgelöst ist; das Original wandert vorher in den Papierkorb und lässt sich zurückholen. Braucht ffmpeg auf dem System.":
      "Finds MP3s below 192 kbps and, on request, fetches a better version - preferring the plain audio upload („- Topic“) over the video version. A file is only replaced when the version found really is higher quality; the original goes to the trash first and can be brought back. Requires ffmpeg on the system.",
    "🎧 Bitraten prüfen": "🎧 Check bitrates",
    ...
    "⚠ Schritt 1 fehlt noch: ein virtuelles Kabel. Ohne eines kann keine Anwendung Ton in ein Mikrofon schicken - das ist eine Vorgabe von Windows, kein Umweg, den man sich sparen könnte. Rechts holen, installieren, PC neu starten. Danach stellt sich hier alles von selbst ein.":
      "⚠ Step 1 is still missing: a virtual cable. Without one, no application can feed audio into a microphone - that's a Windows rule, not a detour you could skip. Get it on the right, install it, restart your PC. Everything here then sets itself up.",
    "VB-Cable holen": "Get VB-Cable",
    ...
    "📤 Code eingeben und senden": "📤 Enter a code and send",
    "Code zum Empfangen": "Code to receive",
    "Verbindung wird vorbereitet …": "Preparing connection …",
    "Auf dem anderen Gerät scannen oder den Code eintippen.": "Scan on the other device, or type in the code.",
    "Oder diesen Code eintippen:": "Or type in this code:",
    "Code kopieren": "Copy code",
    "Code kopiert.": "Code copied.",
    "Kopieren nicht möglich - Code bitte abtippen.": "Copying not possible - please type the code out.",
    "Gültig für {min} Minuten, danach einmalig verbraucht.": "Valid for {min} minutes, then used up once redeemed.",
    "✅ Verbunden: {names}": "✅ Connected: {names}",
    "Code eingeben": "Enter code",
    "Den Code eingeben, den das andere Gerät anzeigt. Danach erscheint es in der Geräteliste und du kannst ihm Playlists schicken.":
      "Enter the code the other device shows. It then appears in the device list and you can send it playlists.",
    "Verbinden": "Connect",
    "Verbinde …": "Connecting …",
    "Mit {name} verbunden.": "Connected to {name}.",
    ...
    "Doppelt tippen setzt ein Band auf 0 dB zurück.": "Double-tap resets a band to 0 dB.",
    "Flach": "Flat",
    "Akustik": "Acoustic",
    "Bass-Boost": "Bass boost",
    "Bass-Absenkung": "Bass cut",
    "Stimme": "Voice",
    "Rock": "Rock",
    "Elektro": "Electronic",
    "Klassik": "Classical",
    ...
    "Ende: {s}s": "End: {s}s",
    "Trimmen": "Trim",
    "Wird getrimmt …": "Trimming …",
    "Scanne …": "Scanning …",
    "Scan fehlgeschlagen.": "Scan failed.",
    "Trimmen fehlgeschlagen.": "Trimming failed.",
    '🔇 Stille entfernt: „{title}"': "🔇 Silence removed: “{title}”",
    "Rückgängig gemacht.": "Undone.",
    "Rückgängig machen fehlgeschlagen.": "Undo failed.",
    "In dieser Playlist suchen …": "Search in this playlist …",
    "Playlist-Reihenfolge": "Playlist order",
    "Titel (A–Z)": "Title (A–Z)",
    "Interpret (A–Z)": "Artist (A–Z)",
    "Album (A–Z)": "Album (A–Z)",
    "Dauer": "Duration",
    "Reihenfolge umkehren": "Reverse order",
    "Keine Songs gefunden.": "No songs found.",
    "Playlists": "Playlists",
    ...
    "App-Symbol": "App icon",
    "✎ Eigenes Theme": "✎ Custom theme",
    "✎ Theme bearbeiten …": "✎ Edit theme …",
    "Farben": "Colors",
    "Akzentfarbe": "Accent color",
    "Hintergrund": "Background",
    "Flächen / Karten": "Surfaces / cards",
    "Textfarbe": "Text color",
    "Nebentext": "Secondary text",
    "Schriftart": "Font",
    "Ecken-Radius": "Corner radius",
    "Effekte / Hintergrund": "Effects / background",
    "Standard (Inter)": "Default (Inter)",
    "System": "System",
    "Serifen (elegant)": "Serif (elegant)",
